        ...
        >
          <div
            ...
            className="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem]
                       ...
                       to-[#9089fc] opacity-20 sm:left-[calc(50%-30rem)]
                       sm:w-[72.1875rem]"
          />
        </div>
          ...
          <div className="w-full max-w-md space-y-8 text-center">
            ...
            >
              ...
              <div className="mt-4 text-center">
                <p className="text-sm text-gray-400">Noch kein Konto?</p>
                <Link
                  to="/register"
                  className="mt-1 inline-block rounded-md bg-pink-600 px-4 py-2
                             text-sm font-semibold text-white hover:bg-pink-700
